                            ...
                            <Table striped>
                                <tbody>
                                    <tr>
                                        ...
                                        <td className="text-start">{product.price.toLocaleString()}원</td>
                                    </tr>
                                    <tr>
                                    ...
                                    <tr>
                                        ...
                                        <td className="text-start">{product.stock.toLocaleString()}개</td>
                                    </tr>
                                    <tr>
                                    ...
                                    <tr>
                                        ...
                                        <td className="text-start">{product.inputdate}</td>
                                    </tr>
                                </tbody>
                            </Table>
